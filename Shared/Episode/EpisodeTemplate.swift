...
extension EpisodeTemplate {
    ...
    static func template(forLanguage language: LanguageManager.Language, edition: Edition? = nil) -> EpisodeTemplate {
        ...
        template = createTemplate(name: templateName, forLanguage: language, introText: introText, outroText: outroText)
        
        return template
        
    }
    
    private static func createTemplate(name: String, forLanguage language: LanguageManager.Language, introText: String, outroText: String) -> EpisodeTemplate {
...
//    static func dwBrazil(edition: Edition) -> EpisodeTemplate {
//
//        var templateName: String
//        var templateLanguage: LanguageManager.Language
//        var sectionText: String
...
//
//        // language
//        templateLanguage = LanguageManager.Language.brazilian
//
//
//        // section 0 -> Introduction & Headlines
//        switch edition {
//        case .morning:
//            sectionText = "Olá, hoje é {date}. Eu sou {narrator} e este é o Boletim de Notícias da DW Brasil. Confira nesta edição:"
//        case .evening:
//            sectionText = "Olá, hoje é {date}. Eu sou {narrator} e esta é a segunda edição do Boletim de Notícias da DW Brasil. Confira nesta edição:"
//        }
//
//        prefixAudioFile = AudioManager.audioFileForDisplayName("Intro Start")
//        mainAudioFile = AudioManager.audioFileForDisplayName("Intro Main")
