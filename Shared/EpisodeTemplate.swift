...
extension EpisodeTemplate {
    ...
    static func dwBrazil() -> EpisodeTemplate {
        ...
        mainAudioFile = AudioManager.audioFileForDisplayName("Intro Loop")
        ...
        // section 2 -> Stories
        let section2 = EpisodeSection(type: .stories, name: "Stories")
        ...
        mainAudioFile = AudioManager.audioFileForDisplayName("Outro Loop")
